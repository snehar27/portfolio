...
export const metadata = {
  title: "Sneha Rajaraman | Personal Portfolio",
  description: "Sneha Rajaraman is a student...",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div
          className="bg-[#fcdbf1] absolute top-[-6rem] -z-10 right-[11rem] 
        ...
        {/* just because outside is a client component doesn't mean that the inside children have to be as well */}
      </body>
    </html>
  );
}
